...
fun AddDeviceScreen(
    ...
    // Re-checks on resume, not just via the launcher callback - covers the
    // user granting the permission from system Settings while the app was
    // backgrounded, which the launcher callback alone would miss.
